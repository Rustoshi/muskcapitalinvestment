                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            ...
                            <select className={selectClass} value={company} onChange={e => setCompany(e.target.value)}>
                                {["SpaceX", "BoringCompany", "Tesla", "Neuralink", "xAI"].map(c => (
                                    <option key={c} value={c}>{c === "BoringCompany" ? "The Boring Company" : c}</option>
                                ))}
                            </select>
                        </div>
                        <div>
                            ...
                            <p className="text-[10px] text-white/25 mt-1">→ muskcapital.pro/projects/{slug || "…"}</p>
                        </div>
                        <div>
